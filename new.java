...
public class new {
    ...
    public new(int atmNumber, int pin, double balance) {
    ...
    public static void main(String[] args) {
        ...
        new[] accounts = {new new(12345, 6789, 500.0), new new(67890, 1234, 1000.0)};
        System.out.print("Enter new number: ");
        int atmNumber = scanner.nextInt();
        System.out.print("Enter PIN: ");
        int pin = scanner.nextInt();
        boolean found = false;
        for (new account : accounts) {
                ...
                while (true) {
                    ...
                    switch (option) {
                        ...
                        case 5:
                            ...
                            break;
                        case 6:
                            System.out.println("Thank you for using the new");
                            return;
                        default:
    ...
    if (!found) {
        System.out.println("Invalid new number or PIN");
    }
}
